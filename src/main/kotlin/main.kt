...
fun main() {
    val audio = AudioAttachment(1, Audio(1, 1, "Филипп Киркоров", "Зайка моя", "www.vk.com"))
    val audio2 = AudioAttachment(1, Audio(2, 2, "Король и Шут", "Ели мясо мужики", "www.vk.com"))
    val video = VideoAttachment(
        1,
        Video(1, 1, "Gangnam Style", "Первый видеоролик собравший 1_000_000_000 просмотров", 4, "www.vk.com", 2011)
    )
